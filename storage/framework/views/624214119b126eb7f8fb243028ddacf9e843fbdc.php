<html>
<head>
<title>Beauty - <?php echo $__env->yieldContent('title'); ?></title>
<meta charset="utf-8">
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse">
      ...
      <div class="dropdown-menu">
        <a class="dropdown-item" href="<?php echo e(url('men')); ?>">MEN</a>
        <a class="dropdown-item" href="<?php echo e(url('women')); ?>">WOMEN</a>
    
      </div>
    </li>
        <li class="nav-item active">
          <a class="nav-link" href="<?php echo e(url('deals')); ?>">DEALS</a>
        </li>
        <li class="nav-item active">
          <a class="nav-link" href="<?php echo e(url('lookbook')); ?>">LOOKBOOK</a>
        </li>
        <li class="nav-item active">
          <a class="nav-link" href="<?php echo e(url('contact')); ?>">CONTACT</a>
        </li>
        <li class="nav-item active">
          <a class="nav-link" style="color:gold;"href="<?php echo e(url('products')); ?>">ADMIN</a>
        </li>
      </ul>
    </div>
  </div>
            ...
            <div class="col-md-6 px-4">
               ...
               <div class="row ">
                  <div class="col-md-6"><br><br>
                     <ul>
                     <a href="<?php echo e(url('home')); ?>" > <li >  HOME</li></a>
                     <a href="<?php echo e(url('about')); ?>" ><li> ABOUT </li></a>
                     <a href="<?php echo e(url('arrivals')); ?>" ><li>  ARRIVALS </li></a>
                     <a href="<?php echo e(url('deals')); ?>" ><li>DEALS </li></a>
                     <a href="<?php echo e(url('lookbook')); ?>" > <li> LOOKBOOK </li></a>
                     <a href="<?php echo e(url('contact')); ?>" > <li>  CONTACT</li></a>
                     </ul>
                  </div>
...
</html><?php /**PATH C:\wamp64\www\project\resources\views/layout.blade.php ENDPATH**/ ?>